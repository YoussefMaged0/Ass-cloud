...
file_path = "random_paragraphs1.txt"  # Update the file path
...
# Move the filtered data to a shared volume path
shared_volume_path = "/shared_volume"
filtered_file_shared_path = os.path.join(shared_volume_path, filtered_file_path)

os.makedirs(shared_volume_path, exist_ok=True)
os.rename(filtered_file_path, filtered_file_shared_path)

print(f"Filtered data copied to shared volume: {filtered_file_shared_path}")
